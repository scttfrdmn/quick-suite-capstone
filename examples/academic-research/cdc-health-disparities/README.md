...
all three stacks: campus-data discovers and loads the dataset,
campus-compute runs a logistic regression, and campus-router drafts
...
router `analyze` tool requires the campus-router stack to be deployed and
